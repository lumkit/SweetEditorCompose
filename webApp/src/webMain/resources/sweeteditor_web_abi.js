(function (global) {
  ...
  bases.push(
    "composeResources/io.github.lumkit.sweeteditor.generated.resources/files/",
    "native/web/",
    "./",
  );

  function loadFromBase(base) {
    return import(base + "sweeteditor_c_abi.js").then((factory) =>
      factory.default({
  ...
  (async function load() {
    ...
    console.error("Failed to load SweetEditor C ABI", lastError);
  })();
