...
private class EditorImeNode(
    ...
    private val adapter = WebComposeImeAdapter()
...
@OptIn(ExperimentalComposeUiApi::class)
private class WebComposeImeAdapter : EditorImeAdapter {
    ...
    val request: PlatformTextInputMethodRequest = WebEditorTextInputRequest(this)
...
@OptIn(ExperimentalComposeUiApi::class)
private class WebEditorTextInputRequest(
    private val adapter: WebComposeImeAdapter,
