...
private class EditorImeNode(
    ...
    private val adapter = IosComposeImeAdapter()
...
@OptIn(ExperimentalComposeUiApi::class)
private class IosComposeImeAdapter : EditorImeAdapter {
    ...
    val request: PlatformTextInputMethodRequest = IosEditorTextInputRequest(this)
...
@OptIn(ExperimentalComposeUiApi::class)
private class IosEditorTextInputRequest(
    private val adapter: IosComposeImeAdapter,
