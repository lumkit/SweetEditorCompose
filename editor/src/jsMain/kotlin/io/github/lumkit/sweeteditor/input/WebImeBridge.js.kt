...
internal actual fun webImeBridgeInstall(
    ...
    g.__seImeOnKey = onKey
    g.__seImeOnCompositionEnd = onCompositionEnd
    g.__seImeReadOnly = readOnly
    return js(
        """
        (function () {
...
internal actual fun webImeBridgeFocus(token: Int) {
    js("if (globalThis.__seImeTextarea && !globalThis.__seImeReadOnly) { globalThis.__seImeTextarea.focus(); }")
}

internal actual fun webImeBridgeSetReadOnly(token: Int, readOnly: Boolean) {
    val g: dynamic = js("globalThis")
    g.__seImeReadOnly = readOnly
    js("if (globalThis.__seImeTextarea && globalThis.__seImeReadOnly) { globalThis.__seImeTextarea.blur(); }")
}

internal actual fun webImeBridgeDestroy(token: Int) {
    js(
        """
        (function () {
